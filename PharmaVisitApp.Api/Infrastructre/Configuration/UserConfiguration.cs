...
namespace PharmaVisitApp.Api.Infrastructre.Configuration
{
    public class UserConfiguration : IEntityTypeConfiguration<User>
    {
        public void Configure(EntityTypeBuilder<User> builder)
        {
            ...
            builder.Property(x=> x.AdConnect).IsRequired(false).HasMaxLength(255);
            ...
            builder.Property(x=> x.PasswordSalt).IsRequired(true).HasMaxLength(255);
            ...
            builder.Property(x=> x.ModifiedAt).IsRequired(true).HasColumnType("date");
            builder.Property(x=> x.ModifiedBy).IsRequired(true).HasMaxLength(100);
        }
    }
}