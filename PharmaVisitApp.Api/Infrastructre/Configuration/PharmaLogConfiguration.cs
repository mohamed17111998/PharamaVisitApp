...
{
    public class PharmaLogConfiguration : IEntityTypeConfiguration<PharmaLog>
    {
        public void Configure(EntityTypeBuilder<PharmaLog> builder)
        {
            builder.HasKey(x => x.Id);
            builder.Property(x => x.Id).ValueGeneratedNever();
            builder.Property(x => x.CodeX3).IsRequired(true).HasMaxLength(255);
            ...
            builder.Property(x => x.PharmacieId).IsRequired(false).HasMaxLength(100);
            builder.Property(x => x.IsValid).IsRequired(false);
            builder.Property(x => x.OperationType).IsRequired(true).HasMaxLength(100);
            ...
            builder.Property(x => x.ValidatedAt).IsRequired(false).HasColumnType("date");
            builder.Property(x => x.ValidatedBy).IsRequired(false).HasMaxLength(100);
        }
    }
}
